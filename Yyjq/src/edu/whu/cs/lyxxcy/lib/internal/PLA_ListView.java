...
package edu.whu.cs.lyxxcy.lib.internal;
...
import edu.whu.cs.lyxxcy.lib.DebugUtil;
 ...
 * <p>
 * See the <a href="{@docRoot}resources/tutorials/views/hello-listview.html">List View
 * tutorial</a>.
 * </p>
 *
...
public class PLA_ListView extends PLA_AbsListView {
     ...
     * @param flow
     *            If flow is true, align top edge to y. If false, align bottom edge to y.
     */
